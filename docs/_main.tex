...
\caption{\label{tab:ST-AgeAltEffTab}ST: Derived measures (DC): A linear regression model with DC as a dependent variable and Material, Sibling and Age as predictors (reference levels: Material = ASL; Sibling = TD). Note: only TD data following outliers trimming was included.}
\centering
...
\midrule
(Intercept) & 0.03 & 1 & 0.03 & 3.71 & \em{0.062} &  & \\
Material & 0.02 & 1 & 0.02 & 2.45 & \em{0.127} & .08 & [.00, .26]\\
Sibling & 0.02 & 1 & 0.02 & 2.89 & \em{0.098} & .08 & [.00, .27]\\
Age & 0.02 & 1 & 0.02 & 2.45 & \em{0.127} & .08 & [.00, .26]\\
Material x Sibling & 0.01 & 1 & 0.01 & 0.77 & \em{0.388} & .04 & [.00, .18]\\
Material x Age & 0.01 & 1 & 0.01 & 1.99 & \em{0.168} & .04 & [.00, .24]\\
Sibling x Age & 0.03 & 1 & 0.03 & 4.42 & \em{\textbf{0.043}} & .12 & [.00, .32]\\
...
\addlinespace[0.3em]
\multicolumn{13}{l}{\textbf{ASL}}\\
\hspace{1em}Switching (Q-NoAlt-Q-Alt) & 20 & 0.07 & 0.80 & -1.67 & 1.05 & 0.00\% & 23 & 0.11 & 1.19 & -2.51 & 1.28 & 0.00\%\\
\hspace{1em}AMSSN (AMSSN - Q-Alt) & 20 & 0.43 & 1.02 & -1.75 & 1.88 & 0.00\% & 23 & -0.22 & 0.99 & -1.79 & 1.65 & 0.00\%\\
\hspace{1em}ENG\_F (ENG\_F - Q-Alt) & 20 & 0.55 & 0.74 & -0.66 & 2.21 & 5.00\% & 23 & -0.22 & 1.07 & -2.37 & 1.80 & 0.00\%\\
\hspace{1em}MDR\_F (MDR\_F - Q-Alt) & 20 & 0.60 & 0.67 & -1.15 & 1.50 & 0.00\% & 23 & -0.01 & 1.13 & -2.93 & 1.91 & 0.00\%\\
\addlinespace[0.3em]
\multicolumn{13}{l}{\textbf{CCRM}}\\
\hspace{1em}Switching (Q-NoAlt-Q-Alt) & 20 & -0.39 & 1.06 & -2.05 & 2.14 & 5.00\% & 23 & 0.15 & 1.66 & -3.95 & 5.09 & 4.35\%\\
\hspace{1em}AMSSN (AMSSN - Q-Alt) & 20 & 0.13 & 1.18 & -0.94 & 2.48 & 20.00\% & 23 & -0.02 & 1.08 & -2.42 & 1.68 & 0.00\%\\
\hspace{1em}ENG\_F (ENG\_F - Q-Alt) & 20 & 0.52 & 0.94 & -1.17 & 2.15 & 5.00\% & 23 & -0.06 & 1.15 & -2.02 & 2.57 & 8.70\%\\
\hspace{1em}MDR\_F (MDR\_F - Q-Alt) & 20 & 0.41 & 1.27 & -2.32 & 3.58 & 10.00\% & 23 & 0.00 & 1.62 & -3.51 & 4.25 & 4.35\%\\
\hspace{1em}CCRM\_F (CCRM\_F - Q-Alt) & 20 & 0.61 & 1.20 & -1.97 & 2.55 & 25.00\% & 23 & 0.01 & 1.01 & -1.85 & 1.64 & 0.00\%\\
\bottomrule
\multicolumn{13}{l}{\textsuperscript{} abnormal: defined as the percentage of abnormal z-score > 1.96.}\\
\end{tabular}}
\end{table}
...
A separate LMEM model for the full CCRM data, including the CCRM\_F distractor, gave similar results, with a significant main effect of Group (\(\chi^{2}\) = 4.184, \(Df\) = 1, \(p\) = 0.041), whereas there as no signifiacnt main effect of Distractor (\(\chi^{2}\) = 0.990, \(Df\) = 3, \(p\) = 0.804).\\
