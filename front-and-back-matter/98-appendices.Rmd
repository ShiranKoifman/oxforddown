...
```{r, ref.label='LiSNS-SRTcorr', fig.cap="LiSNS-UK: Correlations for listeners SRTs (dB SNR).", out.width='90%', fig.align='center', echo=FALSE}

knitr::include_graphics("_main_files/figure-latex/LiSNS-SRTcorr-1.png")
```
