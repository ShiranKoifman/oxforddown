...
# postLMEM.1[1] <-  c("ASL TD - CCRM TD","ASL TD - ASL TD$_{sib}$","ASL TD - CCRM TD$_{sib}$",
#                     "CCRM TD - ASL TD$_{sib}$","CCRM TD - CCRM TD$_{sib}$","ASL TD$_{sib}$ - CCRM TD$_{sib}$")
# 
# postLMEM.1 <- postLMEM.1[c(2,5),]
...
kbl(ST_AgeTab, booktabs = T,escape = F, linesep = "",caption = "ST: Age effect analysis using LMEM for SRdTs measured across condition, speech material, age and children from the TD group with/without an APD sibling (Sibling: TD/TD$_{sib}$) as fixed factors and random intercepts for subjects. Reference levels: Condition = Quiet-NoAlt, Material = ASL, Sibling = TD. Note: only data for the control group (TD) following outlier trimming was included.",
    align = c("lccc"),format = "latex",digits = 3) %>%
    # kable_styling(latex_options = c("scale_down")) %>%
  add_header_above(c("       Condition:Sibling + Material:Sibling + (1 | Subjects)" = 4),align = "r") %>%
  add_header_above(c("       Condition:Material + Condition:Age + Material:Age +" = 4),align = "r",line = FALSE) %>%
...
ggpairs(CCRM_w[c(4:20,2)],
        lower = list(continuous = "smooth"),
        mapping = aes(color = ASLN_w$Group),title="ST-CCRM: Condition - Q-NoAlt (z)")
...
```{r,label='ST-DerivedScoreSRdT',echo=FALSE, message=FALSE, warning=FALSE, results='hide',eval=FALSE}
# Get derived measures ----------------------------------------------------------------------
...
# -- get derived scores --------------------------------------
# uRevs
# ASLN_w$Diff_QAlt   <-  ASLN_w$Q_ASLN_Alt - ASLN_w$Q_ASLN_NoAlt
# ASLN_w$Diff_AMSSN  <-  ASLN_w$AMSSN_ASLN_Alt - ASLN_w$Q_ASLN_NoAlt
# ASLN_w$Diff_MDR    <-  ASLN_w$MDR_F_ASLN_Alt - ASLN_w$Q_ASLN_NoAlt
# ASLN_w$Diff_ENG    <-  ASLN_w$ENG_F_ASLN_Alt - ASLN_w$Q_ASLN_NoAlt

ASLN_w$Diff_QNoAlt   <-  ASLN_w$Q_ASLN_NoAlt - ASLN_w$Q_ASLN_Alt
ASLN_w$Diff_AMSSN  <-  ASLN_w$AMSSN_ASLN_Alt - ASLN_w$Q_ASLN_Alt
ASLN_w$Diff_MDR    <-  ASLN_w$MDR_F_ASLN_Alt - ASLN_w$Q_ASLN_Alt
ASLN_w$Diff_ENG    <-  ASLN_w$ENG_F_ASLN_Alt - ASLN_w$Q_ASLN_Alt

# -- Change data layout from Wide2Long -----------------------
# ASLN_L_uRevs <- ASLN_w %>%
#   select(listener,Age, Group, Diff_QAlt:Diff_ENG) %>%
#   pivot_longer(
#     cols = c("Diff_QAlt","Diff_AMSSN",
#              "Diff_MDR","Diff_ENG"),
#     names_to = "CondCode",
#     names_ptypes = list(CondCode = factor()),
#     values_to = "uRevs") %>%
...
ASLN_L_uRevs <- ASLN_w %>%
  select(listener,Age, Group, Diff_QNoAlt:Diff_ENG) %>%
  pivot_longer(
...
# -- get derived scores --------------------------------------
# uRevs
# CCRM_w$Diff_QAlt   <-  CCRM_w$Q_CCRM_Alt - CCRM_w$Q_CCRM_NoAlt
# CCRM_w$Diff_AMSSN  <-  CCRM_w$AMSSN_CCRM_Alt - CCRM_w$Q_CCRM_NoAlt
# CCRM_w$Diff_MDR    <-  CCRM_w$MDR_F_CCRM_Alt - CCRM_w$Q_CCRM_NoAlt
# CCRM_w$Diff_ENG    <-  CCRM_w$ENG_F_CCRM_Alt - CCRM_w$Q_CCRM_NoAlt
# CCRM_w$Diff_CCRM   <-  CCRM_w$CCRM_F_CCRM_Alt - CCRM_w$Q_CCRM_NoAlt

CCRM_w$Diff_QNoAlt   <-  CCRM_w$Q_CCRM_NoAlt - CCRM_w$Q_CCRM_Alt
CCRM_w$Diff_AMSSN  <-  CCRM_w$AMSSN_CCRM_Alt - CCRM_w$Q_CCRM_Alt
CCRM_w$Diff_MDR    <-  CCRM_w$MDR_F_CCRM_Alt - CCRM_w$Q_CCRM_Alt
CCRM_w$Diff_ENG    <-  CCRM_w$ENG_F_CCRM_Alt - CCRM_w$Q_CCRM_Alt
CCRM_w$Diff_CCRM   <-  CCRM_w$CCRM_F_CCRM_Alt - CCRM_w$Q_CCRM_Alt

# -- Change data layout from Wide2Long -----------------------
# CCRM_L_uRevs <- CCRM_w %>%
#   select(listener, Age, Group, Diff_QAlt:Diff_CCRM) %>%
#   pivot_longer(
#     cols = c("Diff_QAlt","Diff_AMSSN",
...
CCRM_L_uRevs <- CCRM_w %>%
  select(listener, Age, Group, Diff_QNoAlt:Diff_CCRM) %>%
  pivot_longer(
    cols = c("Diff_QNoAlt","Diff_AMSSN",
             "Diff_MDR","Diff_ENG","Diff_CCRM"),
    names_to = "CondCode",
...
```{r,label='ST-DerivedScoreGetz',echo=FALSE, message=FALSE, warning=FALSE, results='hide',eval=FALSE}
# -------------------------------------------------------------
# get z-scores:
# -------------------------------------------------------------
...
# ### Diff_QAlt ###
# df <- ASLN_L_uRevs %>% filter(CondCode=="Diff_QAlt" & Group=="TD") %>% droplevels()
# slope1_temp <- mean(df$uRevs)
# int1_temp <- mean(df$Age)
# # ggplot(df, aes(x=Age,y=uRevs))+
# #   geom_point()+
...
# #   labs(title = levels(df$CondCode))
# 
# Output <- getBestFit(ASLN_L_uRevs,"Diff_QAlt",CutOff,slope1_temp,int1_temp,8,05)
# df_1 <- Output[[1]]  # df_All

### Diff_QNoAlt ###
df <- ASLN_L_uRevs %>% filter(CondCode=="Diff_QNoAlt" & Group=="TD") %>% droplevels()
slope1_temp <- mean(df$uRevs)
int1_temp <- mean(df$Age)
# ggplot(df, aes(x=Age,y=uRevs))+
#   geom_point()+
...
### Diff_AMSSN ###
df <- ASLN_L_uRevs %>% filter(CondCode=="Diff_AMSSN" & Group=="TD") %>% droplevels()
slope1_temp <- mean(df$uRevs)
int1_temp <- mean(df$Age)
# ggplot(df, aes(x=Age,y=uRevs))+
#   geom_point()+
...
### Diff_MDR ###
df <- ASLN_L_uRevs %>% filter(CondCode=="Diff_MDR" & Group=="TD") %>% droplevels()
slope1_temp <- mean(df$uRevs)
int1_temp <- mean(df$Age)
# ggplot(df, aes(x=Age,y=uRevs))+
#   geom_point()+
...
### Diff_ENG  ###
df <- ASLN_L_uRevs %>% filter(CondCode=="Diff_ENG" & Group=="TD") %>% droplevels()
slope1_temp <- mean(df$uRevs)
int1_temp <- mean(df$Age)
# ggplot(df, aes(x=Age,y=uRevs))+
#   geom_point()+
...
# ### Diff_QAlt ###
# df <- CCRM_L_uRevs %>% filter(CondCode=="Diff_QAlt" & Group=="TD") %>% droplevels()
# slope1_temp <- mean(df$uRevs)
# int1_temp <- mean(df$Age)
# # ggplot(df, aes(x=Age,y=uRevs))+
# #   geom_point()+
...
# #   labs(title = levels(df$CondCode))
# 
# Output <- getBestFit(CCRM_L_uRevs,"Diff_QAlt",CutOff,slope1_temp,int1_temp,10)
# df_1 <- Output[[1]]  # df_All

### Diff_QNoAlt ###
df <- CCRM_L_uRevs %>% filter(CondCode=="Diff_QNoAlt" & Group=="TD") %>% droplevels()
slope1_temp <- mean(df$uRevs)
int1_temp <- mean(df$Age)
# ggplot(df, aes(x=Age,y=uRevs))+
#   geom_point()+
...
### Diff_AMSSN ###
df <- CCRM_L_uRevs %>% filter(CondCode=="Diff_AMSSN" & Group=="TD") %>% droplevels()
slope1_temp <- mean(df$uRevs)
int1_temp <- mean(df$Age)
# ggplot(df, aes(x=Age,y=uRevs))+
#   geom_point()+
...
### Diff_MDR ###
df <- CCRM_L_uRevs %>% filter(CondCode=="Diff_MDR" & Group=="TD") %>% droplevels()
slope1_temp <- mean(df$uRevs)
int1_temp <- mean(df$Age)
# ggplot(df, aes(x=Age,y=uRevs))+
#   geom_point()+
...
### Diff_ENG  ###
df <- CCRM_L_uRevs %>% filter(CondCode=="Diff_ENG" & Group=="TD") %>% droplevels()
slope1_temp <- mean(df$uRevs)
int1_temp <- mean(df$Age)
# ggplot(df, aes(x=Age,y=uRevs))+
#   geom_point()+
...
### Diff_CCRM  ###
df <- CCRM_L_uRevs %>% filter(CondCode=="Diff_CCRM" & Group=="TD") %>% droplevels()
slope1_temp <- mean(df$uRevs)
int1_temp <- mean(df$Age)
# ggplot(df, aes(x=Age,y=uRevs))+
#   geom_point()+
...
# Lines.CCRM_Diff <- rbind(L1,L2,L3,L4)
...
```{r, label='ST-DerivedPlots2z', fig.cap="Add caption here.", fig.align='center', fig.width=8, fig.asp=1, out.width='100%',echo=FALSE, message=FALSE, warning=FALSE, results='hide',eval=FALSE, show=FALSE}
...
p1 <- ggplot(ASLN_Diff, aes(x=CondCode,y=z_trim,fill=Group))+ 
  ...
  labs(y = latex2exp::TeX("\\textbf{\\overset{standardised residual (z-score)}{$\\leftarrow$ better performance}}"),x = NULL)+
  # annotate("text", label = latex2exp::TeX("$\\leftarrow$ better performance"),x=0.48, y=1, angle=90, size=5)+
  annotate(geom ="text",  x=1, y = 6, label = "ST-ASL", size=9, face="bold",fontface=2) +
  # scale_fill_discrete(name = "Group", labels = c("APD", "TD",bquote(bold(TD[sib]))))+
  # geom_text(aes(label = ifelse(ASLN$z_trim>CutOff,ASLN$listener,"")),
  # position = position_dodge2(width = .8,padding = 0.1))+
...
p2 <- ggplot(CCRM_Diff, aes(x=CondCode,y=z_trim,fill=Group))+ 
  ...
  labs(y = latex2exp::TeX("\\textbf{\\overset{standardised residual (z-score)}{$\\leftarrow$ better performance}}"),x = NULL)+
  # annotate("text", label = latex2exp::TeX("$\\leftarrow$ better performance"),x=0.48, y=1, angle=90, size=5)+
  annotate(geom ="text",  x=1.3, y = 6, label = "ST-CCRM", size=9, face="bold",fontface=2) +
  # scale_fill_discrete(name = "Group", labels = c("APD", "TD",bquote(bold(TD[sib]))))+
  # geom_text(aes(label = ifelse(ASLN$z_trim>CutOff,ASLN$listener,"")),
  # position = position_dodge2(width = .8,padding = 0.1))+
  scale_y_continuous(limits = c(-4,6),breaks=seq(-4,6,2))+
...
```{r, label='ST-DerivedPlots2', fig.cap="Add caption here.", fig.align='center', fig.width=8, fig.asp=1, out.width='100%',echo=FALSE, message=FALSE, warning=FALSE, results='hide',eval=FALSE, show=FALSE}
...
p1 <- ggplot(ASLN_Diff, aes(x=CondCode,y=uRevs,fill=Group))+ 
  geom_boxplot(position=position_dodge(width=0.8),outlier.shape=NA)+ 
  geom_quasirandom(dodge.width=0.9,shape=1,colour="blue")+
  # geom_hline(yintercept=0, linetype="dashed",color = "black", size=0.5) +
  # labs(y = latex2exp::TeX("\\textbf{\\overset{standardised residual (z-score)}{$\\leftarrow$ better performance}}"),x = NULL)+
...
p2 <- ggplot(CCRM_Diff, aes(x=CondCode,y=uRevs,fill=Group))+ 
  geom_boxplot(position=position_dodge(width=0.8),outlier.shape=NA)+ 
  geom_quasirandom(dodge.width=0.9,shape=1,colour="blue")+
  # geom_hline(yintercept=0, linetype="dashed",color = "black", size=0.5) +
  # labs(y = latex2exp::TeX("\\textbf{\\overset{standardised residual (z-score)}{$\\leftarrow$ better performance}}"),x = NULL)+
...
p1 <- ggplot(ASLN_Diff, aes(x=Age, y=uRevs, colour=Group)) +
  # geom_hline(yintercept=0.97, linetype="dashed",colour = "black", size=0.5)+
  # geom_hline(yintercept=0.05, linetype="dashed",colour = "black", size=0.5)+
  geom_point(size=2,alpha=1,aes(colour=Group),show.legend = FALSE) +
  # geom_text(label=ASLN$listener, size=3)+
...
```{r,label='LiSNS-AgeLMEM-SRM', message=FALSE, warning=FALSE, include=FALSE, echo=FALSE,results='hide'}
# Test for age effect -----------------------------------------------------------------------------------
...
ggpairs(LiSNS_corr[c(4,5:7,2)],
        ...
        diag = list(continuous = wrap("densityDiag", alpha=0.7), aes(fill = ALiSNS_corr$Group)),
