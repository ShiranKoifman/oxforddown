...
```{r LiSNS-SRTcorr, dev='png', fig.align='center', fig.width=14, fig.asp=0.5, out.width='90%', message=FALSE, warning=FALSE, echo=FALSE}
...
```{r, label='LiSNS-zCorr', dev='png', fig.align='center', fig.width=14, fig.asp=0.5, out.width='90%', message=FALSE, warning=FALSE, echo=FALSE}
...
ENVASA_AgeTab <- data.frame(rbind(
  ...
  c("Age",Age.LMEM$Df[2],Age.LMEM$Chisq[2], sprintf("\\textbf{<0.001}")),
  c("APD-sibling",APDsib.LMEM$Df[2],APDsib.LMEM$Chisq[2],sprintf("%.03f",APDsib.LMEM$`Pr(>Chisq)`[2]))))
...
kbl(ENVASA_AgeTab, booktabs = T,escape = F, linesep = "",caption = "ENVASA: Age effect - LMEM model for PC (\\%-correct) in the three background measures single, dual, \\& combind background/s (reference level: single-background), and age as fixed factors and random intercept for subjects. Note: only data measured with the control group following outliers trimming was included.",
    align = c("lccc"),format = "latex",digits = 3) %>% 
...
# Add EHF PTA
d_Info <- d_HF_PTA_L %>% filter(PTA=="PTA_RL") %>% select(., listener, "PTA_EHF"=dBHL) %>% merge(., d_Info, by="listener")
...
```{r echo=FALSE, fig.align='center', fig.asp=1, fig.cap="Add caption here.", fig.width=12, message=FALSE, warning=FALSE, label='EvalAPD-fig', out.width='80%'}
...
t3 <- ggplot(Eval_APD_L, aes(x=Grommets,y=score)) +
    geom_boxplot(position=position_dodge(width=0.8),outlier.shape=NA) + 
  geom_quasirandom(dodge.width=0.8,shape=1,colour="blue")+
  scale_x_discrete(labels=c("1" = "Grommets", "0" = "No \n Grommets"))+
  labs(y="Scaled score" ,x = "") + 
  theme_bw()+
  theme(axis.text = element_text(size = 11, face="bold",colour = "black"),
        axis.title.x = element_text(size=11, face="bold"),
...
t5 <- ggplot(Eval_APD[which(Eval_APD$Diagnosis=="APD"),], aes(x=SPD,y=SRM)) +
    geom_boxplot(position=position_dodge(width=0.8),outlier.shape=NA) + 
  geom_quasirandom(dodge.width=0.8,shape=1,colour="blue")+
  scale_x_discrete(labels=c("1" = "SPD", "0" = "APD"))+
  labs(y = "SRM (z-score)" ,x = "", title="only with APD diagnosis") +
  theme_bw()+
  theme(axis.text = element_text(size = 11, face="bold",colour = "black"),
        axis.title.x = element_text(size=11, face="bold"),
        axis.title.y = element_text(size=11, face="bold"),
...
t5 <- ggplot(Eval_APD, aes(x=SPD,y=SRM)) +
    geom_boxplot(position=position_dodge(width=0.8),outlier.shape=NA) + 
  geom_quasirandom(dodge.width=0.8,shape=1,colour="blue")+
  scale_x_discrete(labels=c("1" = "SPD", "0" = "APD"))+
  labs(y = "SRM (z-score)" ,x = "", title="APD and LiD") +
  theme_bw()+
  theme(axis.text = element_text(size = 11, face="bold",colour = "black"),
        axis.title.x = element_text(size=11, face="bold"),
        axis.title.y = element_text(size=11, face="bold"),
...
t6 <- ggplot(Eval_APD_L, aes(x=EarProblems,y=SRM)) +
    geom_boxplot(position=position_dodge(width=0.8),outlier.shape=NA) + 
  geom_quasirandom(dodge.width=0.8,shape=1,colour="blue")+
  scale_x_discrete(labels=c("1" = "OME", "0" = "No OME"))+
...
t7 <- ggplot(Eval_APD_L, aes(x=AuditoryTraining,y=SRM)) +
    geom_boxplot(position=position_dodge(width=0.8),outlier.shape=NA) + 
  geom_quasirandom(dodge.width=0.8,shape=1,colour="blue")+
...
t8 <- ggplot(Eval_APD_L, aes(x=Grommets,y=SRM)) +
    geom_boxplot(position=position_dodge(width=0.8),outlier.shape=NA) + 
  geom_quasirandom(dodge.width=0.8,shape=1,colour="blue")+
  scale_x_discrete(labels=c("1" = "Grommets", "0" = "No \n Grommets"))+
  labs(y = "SRM (z-score)" ,x = "") +
...
t9 <- ggplot(Eval_APD_L, aes(x=EarProblems,y=PTA)) +
    geom_boxplot(position=position_dodge(width=0.8),outlier.shape=NA) + 
  geom_quasirandom(dodge.width=0.8,shape=1,colour="blue")+
  scale_x_discrete(labels=c("1" = "OME", "0" = "No OME"))+
  labs(y = "Standard PTA \n (dB HL)" ,x = "") + 
...
t10 <- ggplot(Eval_APD_L, aes(x=Grommets,y=PTA)) +
    geom_boxplot(position=position_dodge(width=0.8),outlier.shape=NA) + 
  geom_quasirandom(dodge.width=0.8,shape=1,colour="blue")+
  scale_x_discrete(labels=c("1" = "Grommets", "0" = "No \n Grommets"))+
  labs(y = "Standard PTA \n (dB HL)" ,x = "") + 
...
t11 <- ggplot(Eval_APD_L, aes(x=EarProblems,y=PTA_EHF)) +
    geom_boxplot(position=position_dodge(width=0.8),outlier.shape=NA) + 
  geom_quasirandom(dodge.width=0.8,shape=1,colour="blue")+
  scale_x_discrete(labels=c("1" = "OME", "0" = "No OME"))+
  labs(y = "EHF PTA \n (dB HL)" ,x = "") + 
...
t12 <- ggplot(Eval_APD_L, aes(x=Grommets,y=PTA_EHF)) +
    geom_boxplot(position=position_dodge(width=0.8),outlier.shape=NA) + 
  geom_quasirandom(dodge.width=0.8,shape=1,colour="blue")+
  scale_x_discrete(labels=c("1" = "Grommets", "0" = "No \n Grommets"))+
  labs(y = "EHF PTA \n (dB HL)" ,x = "") + 
...
(t1 + t2 + t3 + t4 + t5 + t6 + t7 + t8 + t9 + t10 + t11 + t12) + plot_layout(ncol = 4, nrow = 5, heights = c(1,1), widths = c(1,1)) + plot_annotation(tag_levels = 'A') + plot_layout(guides='collect') &
  theme(legend.position='bottom',        
        legend.direction = "horizontal",
        legend.background = element_blank(),
        legend.box.background = element_rect(colour = "black"),
