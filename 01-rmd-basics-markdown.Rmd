...
```
#### Test-retest
```{r,label='TestRetest-analysis1', message=FALSE, warning=FALSE, include=FALSE, echo=FALSE,results='hide'}
...
```{r,label='TestRetest-analysis2', message=FALSE, warning=FALSE, include=FALSE, echo=FALSE,results='hide'}
...
```{r, label='Test-RetestTab', echo=FALSE}
...
```{r,label='DC-LMEM-Q2', message=FALSE, warning=FALSE, include=FALSE, echo=FALSE,results='hide'}
...
```{r, label='Quiet_PostHocTab', echo=FALSE}
# prepare table using kbl()
# for more options see: https://cran.r-project.org/web/packages/kableExtra/vignettes/awesome_table_in_pdf.pdf
